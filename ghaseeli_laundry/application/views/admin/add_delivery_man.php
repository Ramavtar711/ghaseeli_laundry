      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0"> Delivery Man</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item text-white"><a href="dashboard.php"><i class="fa fa-home text-primary"></i></a></li>
                
                
                <li class="breadcrumb-item active text-white" aria-current="page">Delivery Man </li>
              </ol>
            </nav>
          </div>
        </div>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-header border-0">
            <span class="h3">Delivery Man</span>
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                            ...
                            <div class="my-0">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <label class="form-control-label" for="password">Expiration Date</label> 
                                  
                                        <input autocomplete="text" class="form-control" name="expiration_date" placeholder="Expiration Date" type="date" value="<?=$row['expiration_date'];?>"required>
                                    
                                </div>
                                
                                  <div class="form-group">
                                    <label class="form-control-label" for="password">National Id</label> 
                                    <input  class="form-control" id="national_id" name="national_id" placeholder="National Id" type="text" value='<?=$row['national_id'];?>'>
                                    
                                </div>
                                
                                  <div class="form-group">
                                    <label class="form-control-label" for="password">License Number</label> 
                                    <input  class="form-control" id="license_number" name="license_number" placeholder="License Number" type="text" value='<?=$row['license_number'];?>'>
                         ...
                         <!--          <div class="form-group">
                             ...
                             <!--   <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <label class="form-control-label" for="password">License Image</label> 
