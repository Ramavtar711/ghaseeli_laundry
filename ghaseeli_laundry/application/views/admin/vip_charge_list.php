...
<?php include('include/sidebar.php'); ?>
    ...
    <div class="main-content">
        <?php include('include/header_bar.php');
               ...
               $branch_id =   $admin->id;
               $userList = $this->admin_common_model->get_where('VIP_Charge',['branch_id'=>$branch_id]);
        ?>
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Charge Wallet </h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page"> Charge Wallet </li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">Charge Wallet Table</h3>
                            ...
                            <table class="table align-items-center table-flush" id="dataTableReport">
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                      ...
                                      <a class="table-action text-warning" href="<?= base_url('admin/page/add_vip_charge/'.$row['id']) ?>">
