      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Addon List</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">Addon List </li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">Addon Table</h3>
                           
                            <a href="<?php echo base_url('admin/page/add_addon'); ?>" class="btn btn-sm btn-primary float-right mt--4"><i class="fa fa-plus mr-1"></i> New</a>
                            ...
                            <table class="table align-items-center table-flush" id="dataTableReport">
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                     ...
                                     <td><p><?= $extra_options_item[0]['child_cate_name']; ?></p></td>
                                        <td><p><?= $row['name']; ?></p></td>   
                                        <td><p><?= $row['price']; ?></p></td>   
