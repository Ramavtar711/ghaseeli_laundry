...
<?php include('include/sidebar.php'); ?>
    ...
    <div class="main-content">
        <?php include('include/header_bar.php');
         ...
         if($admin->type=='ADMIN'){
           $sub_categoryList = $this->admin_common_model->get_where('sub_category',['branch_id'=>$admin_id]); 
                            ...
                            <table class="table align-items-center table-flush" id="dataTableReport">
                                <thead class="thead-light">
                                    ...
                                    <th class="sort" scope="col">Category Name</th>
                                     <th class="sort" scope="col">Sub Category Name</th>
                                ...
                                <tbody class="list">
                                          ...
                                          <?php $i=2; foreach($sub_categoryList as $row){  
                                            ...
                                            $categoryList = $this->admin_common_model->get_where('category',['id'=>$row['category_id']]);
                                    ...
                                    <tr>
                                        ...
                                        <td><p><?= $categoryList[0]['category_name']; ?></p></td>   
