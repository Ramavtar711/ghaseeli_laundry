      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Add VIP Discount</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                 ...
                 <li class="breadcrumb-item active text-white" aria-current="page">Add VIP Discount</li>
              </ol>
            </nav>
          </div>
        </div>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-header border-0">
            <span class="h3">add VIP Charge</span>
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                            ...
                            <div class="my-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  class="form-control" id="" name="amount" placeholder="Amount" type="text" value="<?=$row['amount'];?>"required>
                               </div>
                               
                              
                               <div class="form-group">
                                    <label class="form-control-label" for="name_create"></label> 
                                    <input  class="form-control" id="" name="coupon_code" placeholder="Coupon Code" type="text" value="<?=$row['coupon_code'];?>"required>
                               </div>
                              ...
                              <div class="form-group">
                          <label class="form-control-label" for="role">Select User</label> 
...
if(isset($submit)){
              ...
              $arr_data = $this->input->post();
               ...
               $arr_data['branch_id'] =$admin->id;
               $arr_data['user_id'] = implode(",", $arr_data['user_id']);
               
 /*   foreach($arr_data['user_id'] as $key => $val){
               $branch_id =$admin_id;
               $percentage =$arr_data['percentage'];
               $user_id =$val;
               
            unset($arr_data['submit'],$arr_data['id']);
            $result = $this->admin_common_model->insert_data('vip_discount',['user_id'=>$user_id,'percentage'=>$percentage,'branch_id'=>$branch_id]); 
