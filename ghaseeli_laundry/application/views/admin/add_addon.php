                            ...
                            <div class="my-0">
                                     ...
                                     <label for="inputEmail3" class="col-sm-2 control-label">Select Product</label>
                                          <?php $child_category = $this->admin_common_model->get_all('child_category');  ?>
                                            ...
                                            <option <?php if($row['product_id'] == $child_category_name['id']){echo 'selected' ; } ?> value="<?=$child_category_name['id']?>" ><?=$child_category_name['child_cate_name'];?></option>
                                            <?php } ?>
                                            </select>
                                          </div> 
                                      ...
                                      <div class="form-group">
                                           <label class="form-control-label" for="name_create">Name(English)</label> 
                                           <input  class="form-control" id="name" name="name" placeholder="Name" type="text" value="<?=$row['name'];?>"required>
                                       </div>
                                       <div class="form-group">
                                           <label class="form-control-label" for="name_create">Name(Arabic)</label> 
                                           <input  class="form-control" id="name" name="name_ar" placeholder="Name" type="text" value="<?=$row['name_ar'];?>"required>
                                       </div>
                                   ...
                                   <div class="form-group">
                                           ...
                                           <input  class="form-control" id="sub_cat_name" name="price" placeholder="Price" type="number" value="<?=$row['price'];?>"required>
                                       </div>
