          ...
          <div class="col-lg-6 col-7">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page"> Category List </li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <a href="<?php echo base_url('admin/page/add_category'); ?>" class="btn btn-sm btn-primary float-right mt--4"><i class="fa fa-plus mr-1"></i> New</a>
