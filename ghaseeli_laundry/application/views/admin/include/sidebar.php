   ...
   <li class="nav-item">
                        ...
                        <div class="collapse  " id="navbar-examples">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('admin/display_rides?act=All'); ?>">All</a>
                                </li>
                                <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('admin/display_rides?act=Pending'); ?>">Pending</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('admin/display_rides?act=Confirmed'); ?>">Confirmed</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('admin/display_rides?act=Pickup'); ?>">Pickup</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('admin/display_rides?act=Progress'); ?>">Progress</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('admin/display_rides?act=Shipped'); ?>">Shipped</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('admin/display_rides?act=Delivered'); ?>">Delivered</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('admin/display_rides?act=Cancel'); ?>">Cancel</a>
                                </li>
                            </ul>
                        </div>
                    </li>
