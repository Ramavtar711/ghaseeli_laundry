      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Add wallet</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                 ...
                 <li class="breadcrumb-item active text-white" aria-current="page">Add wallet</li>
              </ol>
            </nav>
          </div>
        </div>
       ...
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                            ...
                            <div class="my-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  class="form-control" id="" name="wallet_amount" placeholder="Wallet Amount" type="text" value="<?=$row['wallet_amount'];?>"required>
