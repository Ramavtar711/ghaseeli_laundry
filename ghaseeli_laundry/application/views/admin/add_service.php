      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Add Services</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">Add Services</li>
              </ol>
            </nav>
          </div>
        </div>
       ...
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                           ...
                           <!--     <img src="<?=$path;?>" alt="" width="200">-->
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="form-control-label" for="name_create">Services Name(English)</label> 
                                    <input  class="form-control" id="category_name" name="category_name" placeholder="Services Name" type="text" value="<?=$row['category_name'];?>"required>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <label class="form-control-label" for="name_create">Services Name(Arabic)</label> 
                                    <input  class="form-control" id="category_name" name="category_name_ar" placeholder="Services Name" type="text" value="<?=$row['category_name_ar'];?>"required>
