      ...
      <div class="col">
       ...
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                            ...
                            <!--<div class="avatar-upload">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="name_create">Category Name(English)</label> 
                                 ...
                                 <div class="form-group">
                                    <label class="form-control-label" for="name_create">Category Name(Arabic)</label> 
                                    <input  class="form-control" id="sub_cat_name" name="sub_cat_name_ar" placeholder="Category Name" type="text" value="<?=$row['sub_cat_name_ar'];?>"required>
