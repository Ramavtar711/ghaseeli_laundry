          ...
          <div class="col-lg-6 col-7">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page"> Product Report </li>
              </ol>
            </nav>
          </div>
        </div>
                                ...
                                <tr>
                                 <th scope="col" class="sort">#</th>
                                    ...
                                    <th class="sort" scope="col">Amount</th>
                                      <th class="sort" scope="col">Tax</th>
                                      ...
                                      <tr>
                                       ...
                                       <td>
                                            ...
                                            <img src="<?=$img_url;?>" alt="" width="50"> 
                                               ...
                                               <td><p><?= $service[0]['category_name']; ?></p></td> 
                                                  <td><p><?= $category[0]['sub_cat_name']; ?></p></td> 
