      ...
      <div class="col">
       ...
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                            ...
                            <?php  } } ?>        
                                        ...
                                        <div class="form-group">
                                        <label class="form-control-label" for="name_create"> Category Name</label> 
                                        <select class="form-control" name="sub_category_id" id="vState" onchange="setCity(this.value,'<?=$row['sub_category_id']?>');">
                                        <option value="">Select</option> 
                                        </select>
                                        </div>        
                                          <div class="form-group">
                                           <label class="form-control-label" for="name_create">Product Name(English)</label> 
                                           <input  class="form-control" id="child_cate_name" name="child_cate_name" placeholder="Product Name" type="text" value="<?=$row['child_cate_name'];?>"required>
                                       </div>
                                       <div class="form-group">
                                           <label class="form-control-label" for="name_create">Product Name(Arabic)</label> 
                                           <input  class="form-control" id="child_cate_name" name="child_cate_name_ar" placeholder="Product Name" type="text" value="<?=$row['child_cate_name_ar'];?>"required>
                                       </div>
                                        ...
                                        <input  class="form-control" id="name" name="amount" placeholder="Amount" type="number" value="<?=$row['amount'];?>"required>
                                          ...
                                          <div class="form-group">
                                           <label class="form-control-label" for="name_create">Time Needed</label> 
                                           <input  class="form-control" id="child_cate_name" name="time_needed" placeholder="Time Needed" type="text" value="<?=$row['time_needed'];?>"required>
                                       </div>
                                        ...
                                        <div class="form-group">
			<label for="inputEmail3" class="col-sm-2 control-label">Add Addon: </label>
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                        ...
                        <td class="text-center">Name(English)</td>
                         <td class="text-center">Name(Arabic)</td>
