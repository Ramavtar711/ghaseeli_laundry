      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Add Banner</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">Add Banner</li>
              </ol>
            </nav>
          </div>
        </div>
       ...
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                            ...
                            <div class="my-0">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="name_create">Banner Name</label> 
                                    <input  class="form-control" id="category_name" name="name" placeholder="Banner Name" type="text" value="<?=$row['name'];?>"required>
