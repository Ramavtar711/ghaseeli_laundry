							...
							<div class="row">
								<div class="col-md-6 mb-3 mb-md-0">
									<strong><?= $product[0]['child_cate_name']?></strong><br>
										...
										<span>price :</span> <span class="font-weight-bold">EGP <?= $product[0]['amount'];?> Tax(<?= $product[0]['tax']?>)</span>
									</div>
							  ...
							  <?php 
									 $extra_item_id    = $cart_val['extra_item_id'];
                                      ...
                                      foreach($extra_options_item as $extra_options){
									    ...
									    ?>
								<span><?=  $extra_options['name']?> :</span> <span class="font-weight-bold">EGP <?= $extra_options['price']?></span><br>
									<?php 
                                     }
									} else{ ?>
					...
					<div class="row justify-content-md-end mb-3">
						<div class="col-md-9 col-lg-8">
							<dl class="row text-sm-right">
								...
								<dd class="col-sm-6">EGP<?=$total;?></dd>
							<!--	<dt class="col-sm-6">Tax / Vat:</dt>
							  ...
							  <!--  <dd class="col-sm-6"><?= $place_order[0]['tax']?></dd>-->
							    ...
							    EGP<?=  $sub_total =   $total + $extra_options_total  ;?></dd>
								...
								<dd class="col-sm-6">EGP<?=$sub_total - $place_order[0]['coupon_amount'] + $place_order[0]['delivery_charge'];?></dd>
							</dl>
						</div>
					</div>
				</div>
