    ...
    <div class="container-fluid mt--6">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <a class="text-body  my-2" href="<?php echo base_url('super_admin/page/invoice/'.$place_order[0]['id']); ?>">
        ...
        <!--    <div class="col-md-3">
              ...
              <?php $sub_branch = $this->admin_common_model->get_where('users',['branch_id'=>$admin_id,'type'=>'DRIVER']);  ?>  
...
<div class="dropdown-menu-right">
 ...
 <select class="form-control" name="status" onchange="addOrderstatus('<?php echo $place_order[0]['id']?>',this.value)" style="border: 1px solid #ddd;     color: #525f7f;width: 98px;">
	    <option <?php if($place_order[0]['payment_status'] == 'Pending'){echo 'selected' ; } ?> value="Pending" >Pending</option>
        <option <?php if($place_order[0]['payment_status'] == 'Confirmed'){echo 'selected' ; } ?> value="Confirmed" >Confirmed</option>
          <option <?php if($place_order[0]['payment_status'] == 'Pickup'){echo 'selected' ; } ?> value="Pickup" >Paid</option>
        <option <?php if($place_order[0]['payment_status'] == 'Progress'){echo 'selected' ; } ?> value="Progress" >Progress</option>
          <option <?php if($place_order[0]['payment_status'] == 'Shipped'){echo 'selected' ; } ?> value="Shipped" >Shipped</option>
        <option <?php if($place_order[0]['payment_status'] == 'Delivered'){echo 'selected' ; } ?> value="Delivered" >Delivered</option>
	<option <?php if($place_order[0]['payment_status'] == 'Cancel'){echo 'selected' ; } ?> value="Cancel" >Cancel</option>
	</select>
</div>-->
			...
			<div class="card mb-3 mb-lg-5">
				<div class="card-header" style="display: block!important;">
					<div class="row">
						...
						<div class="col-6 pt-2">
							<h4 style="color: #8a8a8a;">Order Note :</h4>
						</div>
						<div class="col-6 pt-2">
				...
				<div class="card-body">
				         ...
				         $total = 0;
                               ...
                               $total +=     $cart_val['quantity'] *$child_category[0]['price'] ;   
					...
					<div class="media">
						<div class="avatar avatar-xl mr-3"><img alt="Image Description" class="img-fluid"   src="https://lamavietech.ml/lamavie_laundry/uploads/images/USER_IMG95467.png"></div>
						<div class="media-body">
						    
							<div class="row">
								<div class="col-md-6 mb-3 mb-md-0">
									<strong><?= $child_category[0]['child_cate_name']?></strong><br>
									<strong><u>Variation :</u></strong>
									<div class="font-size-sm text-body">
									<!--	<span>type :</span> <span class="font-weight-bold">3Pcs</span>-->
									</div>
									<div class="font-size-sm text-body">
										<span>price :</span> <span class="font-weight-bold"><?= $child_category[0]['price']?></span>
									</div>
								</div>
								<div class="col col-md-2 align-self-center">
									<h4><?= $child_category[0]['price']?>$</h4>
								</div>
								<div class="col col-md-1 align-self-center">
									<h5><?= $cart_val['quantity']?></h5>
								</div>
								<div class="col col-md-3 align-self-center text-right">
									<h5><?= $cart_val['quantity'] *$child_category[0]['price']; ?>$</h5>
								</div>
							</div>
						</div>
					</div>
