...
<?php      $admin = $this->session->userdata('super_admin'); ?>
 ...
 <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <!-- Brand -->
        <a class="navbar-brand pt-0" href="<?php echo base_url('super_admin/dashboard'); ?>">
        ...
        <ul class="nav align-items-center d-md-none">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                    ...
                    <a href="<?php echo base_url('super_admin/page/profile'); ?>" class="dropdown-item">
   ...
   <li class="nav-item">
              ...
              <li class="nav-item">
                        <a class="nav-link " href="<?php echo base_url('super_admin/page/main_branch_list'); ?>">
                            <i class="fa fa-user-secret text-green"></i>
                            <span class="nav-link-text">Main Branch</span>
                        </a>
                    </li>
                        ...
                        <div class="collapse  " id="navbar-examples">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('super_admin/display_rides?act=All'); ?>">All</a>
                                </li>
                                <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('super_admin/display_rides?act=Pending'); ?>">Pending</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('super_admin/display_rides?act=Confirmed'); ?>">Confirmed</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('super_admin/display_rides?act=Pickup'); ?>">Pickup</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('super_admin/display_rides?act=Progress'); ?>">Progress</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('super_admin/display_rides?act=Shipped'); ?>">Shipped</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('super_admin/display_rides?act=Delivered'); ?>">Delivered</a>
                                </li>
                                 <li class="nav-item">
                                 <a class="nav-link " href="<?php echo base_url('super_admin/display_rides?act=Cancel'); ?>">Cancel</a>
                                </li>
                            </ul>
                        </div>
                    </li>
     ...
     // $for_roll = $this->db->query("SELECT * FROM menu_permission WHERE menu_id = '".$smenu['menu_id']."' AND  roll = '$roll_id'")->result_array();
                       ...
                       //  if($for_roll ||  $admin->type == 'ADMIN'){
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('admin/page/'); ?><?=$smenu['link']?>"><?=$smenu['name']?></a>
                                </li>
                              	<?php// } }  ?>
                            </ul>
                        </div>
