<?php include('include/header.php'); ?> 
 ...
 <?php include('include/sidebar.php'); ?>        
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0"><?php echo $title; ?> Report</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item text-white"><a href="<?php echo base_url('super_admin/dashboard'); ?>"><i class="fa fa-home text-primary"></i></a></li>
                
                
                <li class="breadcrumb-item active text-white" aria-current="page"> <?php echo $title; ?> Report </li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="card">
                    <!-- Card header -->
                     ...
                     <div class="card-header">
                        <div class="row">
                       <div class="col-md-6">  
                        <h3 class="mb-0"><?php echo $title; ?> Report</h3>
                        </div> 
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
         <a class="dropdown-item" href="<?php echo base_url('super_admin/display_rides?act=All'); ?>">ALl</a>
    <a class="dropdown-item" href="<?php echo base_url('super_admin/display_rides?act=Pending'); ?>">Pending</a>
    <a class="dropdown-item" href="<?php echo base_url('super_admin/display_rides?act=Confirmed'); ?>">Confirmed</a>
    <a class="dropdown-item" href="<?php echo base_url('super_admin/display_rides?act=Pickup'); ?>">Pickup</a>
    <a class="dropdown-item" href="<?php echo base_url('super_admin/display_rides?act=Progress'); ?>">Progress</a>
    <a class="dropdown-item" href="<?php echo base_url('super_admin/display_rides?act=Shipped'); ?>">Shipped</a>
    <a class="dropdown-item" href="<?php echo base_url('super_admin/display_rides?act=Delivered'); ?>">Delivered</a>
    <a class="dropdown-item" href="<?php echo base_url('super_admin/display_rides?act=Cancel'); ?>">Cancel</a>
  </div>
</div> 
                                  ...
                                  $admin= $this->admin_common_model->get_where('admin',['id'=>$row['branch_id']]);
                                    ...
                                    ?>
                                      ...
                                      <tr>
                                          ...
                                          <td><p><?= $i; ?></p></td>    
                                    <td>
                                         <a href="<?php echo base_url('super_admin/page/order_details/'.$row['id']); ?>" style="color:red;">
                                    ...
                                    <td><p><?= $row['price']; ?>L.E</p></td> 
                                    <td><p><?= $row['payment_type']; ?></p></td>    
                                       <td><p><?= $row['status']; ?></p></td> 
                                       
                                        <td class="table-actions">
                                           <a href="<?php echo base_url('super_admin/page/invoice/'.$row['id']) ?>" class="text-blue cursor table-action"><i class="fas fa-file-invoice"></i></a>
                                        </td>
                                    </tr>
                               <?php $i++;}  ?>     
                              </tbody>
