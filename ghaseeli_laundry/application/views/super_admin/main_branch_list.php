                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">Main Branch  Table</h3><a href="<?php echo base_url('super_admin/page/add_main_branch'); ?>" class="btn btn-sm btn-primary float-right mt--4"><i class="fa fa-plus mr-1"></i> New</a>
                        </div><!-- Light table -->
