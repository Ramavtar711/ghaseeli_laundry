                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">جدول المستخدمين</h3><a href="<?php echo base_url('admin/page/create_new'); ?>" class="btn btn-sm btn-primary float-right mt--4
                            "><i class="fa fa-plus mr-1"></i>الجديد</a>
                        </div><!-- Light table -->
