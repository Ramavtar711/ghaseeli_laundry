      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h4 class="h2 text-white d-inline-block mb-0">فاتورة</h4>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">فاتورة </li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">فاتورة
                        <a class="btn btn-primary addbtn float-right p-2 px-3"  target="_blank" href="#" id="print_invoice" onClick="window.print()">مطبعة</a></h3>
              ...
              <h4 style="color: #8a8a8a;">اختر العنوان :</h4><p>  <?= $place_order[0]['pickup_address']?> </p>
						...
						<div class="col-6 pt-2">
							<div class="text-right">
							        <?php if($place_order[0]['payment_type']=='Card'){ 
							         $payment_type = 'بطاقة';
							          ...
							          if($place_order[0]['payment_type']=='Paid'){ 
							...
							if($place_order[0]['status'] =='Pending'){
							  $status = 'قيد الانتظار';
							    
						      	}
							 
							   elseif ($place_order[0]['status'] =='Confirmed') {
							       $status = 'مؤكد';
							  }
							   elseif ($place_order[0]['status'] =='Pickup') {
							       $status = 'يلتقط';
							  }
							 
							   elseif ($place_order[0]['status'] =='Progress') {
							       $status = 'تقدم';
							  }
							   elseif ($place_order[0]['status'] =='Shipped') {
							       $status = 'شحنها';
							  }
							   elseif ($place_order[0]['status'] =='Delivered') {
							       $status = 'تم التوصيل';
							  }
							   elseif ($place_order[0]['status'] =='Cancel') {
							       $status = 'يلغي';
							  }else{
							        $status = 'قيد الانتظار';
							  }
							...
							<!--	<h4 class="" style="color: #8a8a8a;">Reference Code : <button class="btn btn-outline-primary btn-sm" data-target=".bd-example-modal-sm" data-toggle="modal">Add</button></h4>-->
								<h4 class="text-capitalize" style="color: #8a8a8a;">نوع الطلب : <label class="badge badge-soft-primary" style="font-size: 14px"><?=$status;?></label></h4>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-md-6 mb-3 mb-md-0">
									<strong><?= $product[0]['child_cate_name_ar']?></strong><br>
										...
										<span>سعر :</span> <span class="font-weight-bold"><?= $product[0]['amount']?></span>
									</div>
									...
									<span><?=  $extra_options['name_ar']?> :</span> <span class="font-weight-bold"><?= $extra_options['price']?></span><br>
									<?php 
                                     }
									} else{ ?>
								...
								<div class="col col-md-2 align-self-center">
									<h4>$<?= $product[0]['amount']?></h4>
								</div>
								<div class="col col-md-1 align-self-center">
									<h5><?= $cart_val['quantity']?></h5>
								</div>
								<div class="col col-md-3 align-self-center text-right">
									<h5>$<?= $cart_val['quantity'] *$product[0]['amount']; ?></h5>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row justify-content-md-end mb-3">
						<div class="col-md-9 col-lg-8">
							<dl class="row text-sm-right">
								...
								<dt class="col-sm-6">ضريبة القيمة المضافة:</dt>
							  ...
							  <!--  <dd class="col-sm-6"><?= $place_order[0]['tax']?></dd>-->
								...
								<dd class="col-sm-6">$<?= $sub_total = $total + $product[0]['tax'] + $extra_options_total ;?></dd>
