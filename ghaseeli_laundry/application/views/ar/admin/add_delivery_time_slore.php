      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Time Slote</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active text-white" aria-current="page">Time Slote</li>
              </ol>
            </nav>
          </div>
        </div>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-header border-0">
            <span class="h3">Time Slote</span>
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                                <input type="hidden"  class="form-control" name="id" value="<?=$row['id'];?>">    
                            <div class="my-0">
                             
                                <div class="form-group">
                                    <label class="form-control-label" for="name_create">Open Time</label> 
                                    <input  class="form-control" id="open_time" name="open_time" placeholder="Open Time" type="text" value="<?=$row['open_time'];?>"required>
                                    
                                </div>
                                  <div class="form-group">
                                    <label class="form-control-label" for="name_create">Close Time</label> 
                                    <input  autofocus="" class="form-control" id="close_time" name="close_time" placeholder="Close Time" type="text" value="<?=$row['close_time'];?>"required>
...
$('.confirm').click(function(){
        window.location='".base_url('admin/page/delivery_time_slore')."';
});
