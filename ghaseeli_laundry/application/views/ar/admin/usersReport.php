<?php include('include/header.php'); ?> 
 ...
 <?php include('include/sidebar.php'); ?>        
  ...
  <?php include('include/header_bar.php');
           $place_order = $this->admin_common_model->get_where('users',['type'=>'USER']);
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">تقرير المستخدمين</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page"> تقرير المستخدمين </li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">تقرير المستخدمين</h3>
                    </div>
