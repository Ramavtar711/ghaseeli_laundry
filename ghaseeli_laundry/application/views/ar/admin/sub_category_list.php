      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">قائمة المنتجات</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">قائمة المنتجات </li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">جدول المنتج</h3>
                             
                            <a href="<?php echo base_url('admin/page/add_sub_category'); ?>" class="btn btn-sm btn-primary float-right mt--4"><i class="fa fa-plus mr-1"></i> جديد</a>
                            ...
                            <table class="table align-items-center table-flush" id="dataTableReport">
                                <thead class="thead-light">
                                   ...
                                   <th class="sort" scope="col">اسم التصنيف</th>
                                    <th class="sort" scope="col">اسم المنتج (انجليزي)</th>
                                    <th class="sort" scope="col">اسم المنتج (عربي)</th>
                ...
                <?php $i=2; foreach($sub_categoryList as $row){  
                       ...
                       $serviceList = $this->admin_common_model->get_where('category',['id'=>$row['category_id']]);
                                    ...
                                    <tr>
                                     ...
                                     <td><p><?= $categoryList[0]['sub_cat_name_ar']; ?></p></td>   
