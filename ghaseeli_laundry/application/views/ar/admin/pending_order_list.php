  ...
  <?php include('include/header_bar.php');
   ...
   $branch = $this->session->userdata('admin');
         $branch_id =   $branch->id;
            ...
            $place_order = $this->db->query("SELECT * FROM place_order WHERE branch_id = $branch_id AND status ='Pending' ORDER BY id DESC")->result_array();
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0"> Assigne Orders</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item text-white"><a href="dashboard.php"><i class="fa fa-home text-primary"></i></a></li>
                
                
                <li class="breadcrumb-item active text-white" aria-current="page">Assigne Orders </li>
              </ol>
            </nav>
          </div>
        </div>
