      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Add Notification</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                 ...
                 <li class="breadcrumb-item active text-white" aria-current="page">Add Notification</li>
              </ol>
            </nav>
          </div>
        </div>
      ...
      <div class="col">
       ...
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                 ...
                 <div class="form-group">
                     <label class="form-control-label" for="name_create">Title</label> 
                       <input  class="form-control" id="name" name="title" placeholder="Title" type="text" value="<?=$row['title'];?>"required>
                       </div>
                     ...
                     <label class="form-control-label" for="name_create">Description</label> 
...
$result = $this->admin_common_model->insert_data('push_notification',$arr_data); 
  ...
  $users = $this->admin_common_model->get_where("users",['type'=>'USER']);    
