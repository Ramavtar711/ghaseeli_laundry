...
<?php include('include/sidebar.php'); ?>
    ...
    <div class="main-content">
        <?php include('include/header_bar.php');
         ...
         if($admin->type=='ADMIN'){
              $push_notification = $this->admin_common_model->get_where('push_notification',['branch_id'=>$admin_id]);
       // $push_notification = $this->admin_common_model->get_where('push_notification',['branch_id'=>$admin_id,'type'=>'DRIVER']);
         }
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">تنبيه</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page"> تنبيه </li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">جدول الإخطار</h3>
                
                        <a href="<?php echo base_url('admin/page/add_notification'); ?>" class="btn btn-sm btn-primary float-right mt--4"><i class="fa fa-plus mr-1"></i> جديد</a> </div>
                        ...
                        <table class="table align-items-center table-flush" id="dataTableReport">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="sort">عنوان</th>
                                    <th scope="col" class="sort">وصف</th>
                                   <th>عمل</th>
                                </tr>
                            </thead>
                            <tbody class="list">
