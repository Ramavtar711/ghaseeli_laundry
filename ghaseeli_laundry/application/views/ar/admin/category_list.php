...
<?php include('include/sidebar.php'); ?>
    ...
    <div class="main-content">
        <?php include('include/header_bar.php');
          ...
          if($admin->type=='ADMIN'){
           $categoryList = $this->admin_common_model->get_where('sub_category',['branch_id'=>$admin_id]);
         }
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">قائمة الفئات</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item text-white"><a href="dashboard.php"><i class="fa fa-home text-primary"></i></a></li>
                
                
                <li class="breadcrumb-item active text-white" aria-current="page"> قائمة الفئات </li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">جدول الفئات</h3>
                          
                            <a href="<?php echo base_url('admin/page/add_category'); ?>" class="btn btn-sm btn-primary float-right mt--4"><i class="fa fa-plus mr-1"></i> جديد</a>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                      <!--
                                         ...
                                         <td><p><?= $serviceList[0]['category_name_ar']; ?></p></td>
                                        <td><p><?= $row['sub_cat_name']; ?></p></td>   
                                            <td><p><?= $row['sub_cat_name_ar']; ?></p></td> 
                                     ...
                                     <!--     <button class="btn-white btn shadow-none p-0 m-0 table-action text-info bg-white">  <i class="fas fa-eye"></i></button>-->
                                            ...
                                            <a class="table-action text-warning" href="<?= base_url('admin/page/add_category/'.$row['id']) ?>">
