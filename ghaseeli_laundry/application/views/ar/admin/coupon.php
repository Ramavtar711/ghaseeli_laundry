...
<?php include('include/sidebar.php'); ?>
    ...
    <div class="main-content">
        <?php include('include/header_bar.php');
           ...
           $admin_id =   $admin->id;
           $userList = $this->admin_common_model->get_where('coupon_codes',['branch_id'=>$admin_id]);
         ?>
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">رموز القسيمة </h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item text-white"><a href="dashboard.php"><i class="fa fa-home text-primary"></i></a></li>
                
                
                <li class="breadcrumb-item active text-white" aria-current="page"> رموز القسيمة </li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">جدول رموز القسيمة</h3><a href="<?php echo base_url('admin/page/add_coupon'); ?>" class="btn btn-sm btn-primary float-right mt--4">
                                <i class="fa fa-plus mr-1"></i> جديد</a>
                        </div><!-- Light table -->
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="dataTableReport">
                                <thead class="thead-light">
                                    ...
                                    <th class="sort" scope="col">رمز الكوبون</th>
                                    <th class="sort" scope="col">مقدار</th>
                                      <th class="sort" scope="col">صالح من تاريخ</th>
                                         <th class="sort" scope="col">صالحة ل</th>
                                  <th class="sort" scope="col">حالة</th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                            <td><p><?= $row['coupon_code']; ?></p></td> 
                                            <td><p><?= $row['amount']; ?></p></td> 
                                            <td><p><?= $row['valid_from']; ?></p></td> 
                                            <td><p><?= $row['valid_to']; ?></p></td> 
                                     ...
                                     <!--     <button class="btn-white btn shadow-none p-0 m-0 table-action text-info bg-white">  <i class="fas fa-eye"></i></button>-->
                                            <a class="table-action text-warning" href="<?= base_url('admin/page/add_coupon/'.$row['id']) ?>">
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'coupon_codes', 'id': id}, // change this to send js object
          type: "POST",
