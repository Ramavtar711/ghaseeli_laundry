      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">أضف خدمات</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">أضف خدمات</li>
              </ol>
            </nav>
          </div>
        </div>
                            ...
                            <div class="my-0">
                              <!--  <div class="avatar-upload">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="name_create">اسم الخدمات (انجليزي) </label> 
                                    <input  class="form-control" id="category_name" name="category_name" placeholder="اسم الخدمات (انجليزي)" type="text" value="<?=$row['category_name'];?>"required>
                                    
                                </div>
                                
                                 <div class="form-group">
                                    <label class="form-control-label" for="name_create">اسم الخدمة (عربي)</label> 
                                    <input  class="form-control" id="category_name_ar" name="category_name_ar" placeholder="اسم الخدمة (عربي)" type="text" value="<?=$row['category_name_ar'];?>"required>
...
$('.confirm').click(function(){
        window.location='".base_url('admin/page/service_list')."';
});
