...
<?php include('include/sidebar.php'); ?>
    ...
    <div class="main-content">
        <?php include('include/header_bar.php');
          ...
          if($admin->type=='ADMIN'){
           $categoryList = $this->admin_common_model->get_where('category',['branch_id'=>$admin_id]);
         }
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">قائمة الخدمات</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page"> قائمة الخدمات </li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <a href="<?php echo base_url('admin/page/add_service'); ?>" class="btn btn-sm btn-primary float-right mt--4"><i class="fa fa-plus mr-1"></i> جديد</a>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="dataTableReport">
                                <thead class="thead-light">
                                    ...
                                    <th class="sort" scope="col">اسم الخدمة (انجليزي)</th>
                                       <th class="sort" scope="col">اسم الخدمة (عربي)</th>
                                    ...
                                    <tr>
                                      ...
                                      <!--      <td>
                                        ...
                                        <td><p><?= $row['category_name']; ?></p></td>   
                                         <td><p><?= $row['category_name_ar']; ?></p></td>   
                                     ...
                                     <!--     <button class="btn-white btn shadow-none p-0 m-0 table-action text-info bg-white">  <i class="fas fa-eye"></i></button>-->
                                            ...
                                            <a class="table-action text-warning" href="<?= base_url('admin/page/add_service/'.$row['id']) ?>">
