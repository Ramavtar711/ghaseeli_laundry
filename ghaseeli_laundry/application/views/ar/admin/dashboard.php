        ...
        <div class="header-body mt--4">
            <div class="row align-items-center pb-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block">لوحة القيادة</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active text-white" aria-current="page"> لوحة القيادة </li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">المستخدمون</h5>
                            ...
                            <p class="mt-3 mb-0 text-muted text-sm">
                                <span class="text-nowrap">منذ إطلاق التطبيق</span>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">  
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">خدمات</h5>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">منتج</h5>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">دخل</h5>
             ...
             <div class="col-xl-6">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-muted ls-1 mb-1">مسجل جديد</h6>
                                <h3 class="mb-0">المستخدمون</h3>
                            </div>
                            <div class="col text-right">
                                <a href="<?php echo base_url('page/user');?>" class="btn btn-sm btn-primary">اظهار الكل</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="sort">صورة</th>
                                <th scope="col" class="sort">اسم</th>
                                <th scope="col" class="sort">تاريخ التسجيل</th>
                            </tr>
                        </thead>
                        <tbody class="list">
