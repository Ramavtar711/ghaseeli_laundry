...
<?php include('include/sidebar.php'); ?>
    ...
    <div class="main-content">
        <?php include('include/header_bar.php');
          ...
          $adminList = $this->admin_common_model->get_where('admin',['sub_admin_id'=>$admin_id]);
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">Main Branch  Table</h3><a href="<?php echo base_url('admin/page/add_branch'); ?>" class="btn btn-sm btn-primary float-right mt--4"><i class="fa fa-plus mr-1"></i> New</a>
                        </div><!-- Light table -->
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                     ...
                                     <!--     <button class="btn-white btn shadow-none p-0 m-0 table-action text-info bg-white">  <i class="fas fa-eye"></i></button>-->
                                            <a class="table-action text-warning" href="<?= base_url('admin/page/add_branch/'.$row['id']) ?>">
