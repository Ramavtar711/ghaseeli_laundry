                    ...
                    <div class="login">
                        <div class="center-box">
                            ...
                            <div class="title">
                                ...
                                <h4 class="login_head">دخول المشرف</h4>
                                
                              <?php include("session_msg.php");  ?>
                                
                                
                                <p class="login-para">هذا نظام آمن وستحتاج إلى توفير<br>
                                    تفاصيل تسجيل الدخول للوصول إلى الموقع.</p>
                            </div>
...
<script>
      ...
      // alert(language_name);
        ...
        $.ajax({
         url : "<?php echo base_url('admin/switch_language1');?>",
