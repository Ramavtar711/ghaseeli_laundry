      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">تقرير الإيرادات</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page"> تقرير الإيرادات </li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">تقرير الإيرادات</h3>
                    </div>
                       ...
                       <form action="<?php echo base_url('admin/order_report');?>" method="post" class="form_container left_label" id="" >
						...
						<div class="row">
									<div class="form_grid_12 col-lg-5">
										<label class="field_title">تاريخ البدء <span class="req">*</span>
										</label>
									...
									<div class="form_grid_12 col-lg-5">
										<label class="field_title">تاريخ الانتهاء <span class="req">*</span>
										</label>
										<div class="form_input">
										...
										<div class="form_grid_12 col-lg-2">
								         <div class="form_input" style="margin-top: 2.5rem;">
										    <input type="submit" value="يبحث" class="btn btn-dang-add mr10 form-control" id="Search" name="Search" title="Search" />
										</div>
							     	</div>
								</div>
								</form>
                      ...
                      <div class="btn-group export-btns">
                        ...
                        <table class="table align-items-center table-flush" id="dataTableRevenueReport">
                            <thead class="thead-light">
                                ...
                                <th scope="col" class="sort">اسم االمستخدم</th>
                                <th scope="col" class="sort">تبوك</th>
                                <th scope="col" class="sort">حالة</th>
