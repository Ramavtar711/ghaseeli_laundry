...
<?php include('include/sidebar.php'); ?>
    ...
    <div class="main-content">
        <?php include('include/header_bar.php');
          ...
          $admin_id =   $admin->id;  
          $driverList = $this->admin_common_model->get_where('users',['type'=>'DRIVER','branch_id'=>$admin_id]);
        ?>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">جدول رجل التسليم</h3><a href="<?php echo base_url('admin/page/add_delivery_man'); ?>" class="btn btn-sm btn-primary float-right mt--4"><i class="fa fa-plus mr-1"></i> جديد</a>
                        </div><!-- Light table -->
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="dataTableReport">
                                <thead class="thead-light">
                                    ...
                                    <th class="sort" scope="col"> اسم</th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                     ...
                                     <!--     <button class="btn-white btn shadow-none p-0 m-0 table-action text-info bg-white">  <i class="fas fa-eye"></i></button>-->
                                            <a class="table-action text-warning" href="<?= base_url('admin/page/add_delivery_man/'.$row['id']) ?>">
