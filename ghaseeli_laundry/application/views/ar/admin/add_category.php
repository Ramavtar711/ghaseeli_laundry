       ...
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                            ...
                            <!--<div class="avatar-upload">
                                ...
                                <div class="form-group">
                                     <label for="inputEmail3" class="col-sm-2 control-label">اختر الخدمة</label>
                                          <?php $category = $this->admin_common_model->get_all('category');  ?>
                                            <select name = "category_id" class="form-control" required>
                                            <option value="">--select--</option>
                                            <?php foreach($category as $category_name){?>
                                            <option <?php if($row['category_id'] == $category_name['id']){echo 'selected' ; } ?> value="<?=$category_name['id']?>" ><?=$category_name['category_name_ar'];?></option>
                                            <?php } ?>
                                            </select>
                                          </div> 
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="name_create">اسم الفئة (انجليزي)</label> 
                                    <input  class="form-control" id="sub_cat_name" name="sub_cat_name" placeholder="اسم الفئة (انجليزي)" type="text" value="<?=$row['sub_cat_name'];?>"required>
                                    
                                </div>
                                
                                     
                                <div class="form-group">
                                    <label class="form-control-label" for="name_create">اسم الفئة (عربي)</label> 
                                    <input  class="form-control" id="sub_cat_name_ar"name="sub_cat_name_ar" placeholder="اسماسم الفئة (عربي))" type="text" value="<?=$row['sub_cat_name_ar'];?>"required>
...
$('.confirm').click(function(){
        window.location='".base_url('admin/page/category_list')."';
});
