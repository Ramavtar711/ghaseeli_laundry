...
<?php include('include/sidebar.php'); ?>       
  ...
  <?php include('include/header_bar.php'); 
      ...
      if($id!=''){
        $fetch = $this->admin_common_model->get_where('VIP_Charge',['id'=>$id]);
        $row = $fetch[0];
        $button = "update";
        $btn_name = "تحديث";        
        if($row['image']!=''){
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">إضافة VIP Charge</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                 ...
                 <li class="breadcrumb-item active text-white" aria-current="page">إضافة VIP Charge</li>
              </ol>
            </nav>
          </div>
        </div>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-header border-0">
            <span class="h3">إضافة VIP Charge</span>
       <form action="" class="form-horizontal" enctype="multipart/form-data" id="" method="post" name="">
                            ...
                            <div class="my-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  class="form-control" id="" name="charge" placeholder="تكلفة" type="text" value="<?=$row['charge'];?>"required>
...
$result = $this->admin_common_model->insert_data('VIP_Charge',$arr_data); 
...
$result = $this->admin_common_model->update_data('VIP_Charge',$arr_data, $arr_where); 
//echo $this->db->last_query(); die;
...
$('.confirm').click(function(){
        window.location='".base_url('admin/page/vip_charge_list')."';
});
