      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">المستخدمون </h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page"> قائمة المستخدمين </li>
              </ol>
            </nav>
          </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="dataTableReport">
                                <thead class="thead-light">
                                    ...
                                    <th class="sort" scope="col">اسم االمستخدم</th>
                                    <th class="sort" scope="col">البريد الإلكتروني</th>
                                      <th class="sort" scope="col">التليفون المحمول</th>
                                    <th class="sort" scope="col">تاريخ الوقت</th>
                                    <th class="sort" scope="col">حالة</th>
                                         <th class="sort" scope="col">دردشة</th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                       ...
                                       <td> <a class="table-action text-warning" href="<?= base_url('admin/page/chat/'.$row['id']) ?>">
                                       <button class="btn-white btn shadow-none p-0 m-0 table-action text-info bg-white"><i class="fa fa-chat"></i>دردشة</button></a>  </td>
