    ...
    <div class="container-fluid mt--6">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <a class="text-body  my-2" href="<?php echo base_url('branch/page/invoice/'.$place_order[0]['id']); ?>">
            ...
            <div class="col-md-3">
              ...
              <?php $sub_branch = $this->admin_common_model->get_where('users',['branch_id'=>$branch_id,'type'=>'DRIVER']);  ?>  
					...
					<div class="row justify-content-md-end mb-3">
						<div class="col-md-9 col-lg-8">
							<dl class="row text-sm-right">
								...
								<dd class="col-sm-6"><?= $sub_total = $total + $extra_options_total ;?>L.E</dd>
...
function(){
      $.ajax({
          url: "<?=base_url('branch/updateStatus');?>",
...
function(){
        ...
        $.ajax({
          url: "<?=base_url('branch/UpdatePaymentStatus');?>",
...
function(){
        ...
        $.ajax({
          url: "<?=base_url('branch/addOrderstatus');?>",
