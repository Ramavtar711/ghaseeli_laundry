  ...
  <?php include('include/header_bar.php');
      ...
      $branch = $this->session->userdata('branch');
          $branch_id =   $branch->id;
            ...
            $place_order = $this->db->query("SELECT * FROM place_order WHERE status ='Cancel' AND sub_branch_id = $branch_id ORDER BY id DESC")->result_array();
      ...
      <div class="header-body">
        <div class="row align-items-center py-4 pb-7">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0"> Cancel Orders</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">Cancel Orders </li>
              </ol>
            </nav>
          </div>
        </div>
                            ...
                            $users= $this->admin_common_model->get_where('users',['id'=>$row['user_id']]);
                                  $admin= $this->admin_common_model->get_where('admin',['id'=>$row['branch_id']]);
                                    ...
                                    <tr>
                                        ...
                                        <td><p>    <a href="<?php echo base_url('branch/page/order_details/'.$row['id']); ?>" style="color:red;">
