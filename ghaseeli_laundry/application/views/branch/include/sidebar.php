...
<?php      $admin = $this->session->userdata('branch'); ?>
 ...
 <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <!-- Brand -->
        <a class="navbar-brand pt-0" href="<?php echo base_url('branch/dashboard'); ?>">
        ...
        <ul class="nav align-items-center d-md-none">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                    ...
                    <a href="<?php echo base_url('branch/page/profile'); ?>" class="dropdown-item">
                        <i class="ni ni-single-02"></i>
                        <span>My profile</span>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a href="<?php echo base_url('branch/logout'); ?>" class="dropdown-item">
   ...
   <li class="nav-item">
                        <a class="nav-link " href="<?php echo base_url('branch/dashboard'); ?>">
                     ...
                     <i class="fas fa-tshirt text-purple"></i>
                        ...
                        <div class="collapse  " id="navbar-examples">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('branch/page/order'); ?>">All</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('branch/page/pending_order_list'); ?>">Pending</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('branch/page/pickup_order_list'); ?>">Pickup</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('branch/page/progress_order_list'); ?>">Progress</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('branch/page/shipped_order_list'); ?>">Shipped</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('branch/page/delivered_order_list'); ?>">Delivered</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="<?php echo base_url('branch/page/cancel_order_list'); ?>">Cancel</a>
                                </li>
