    ...
    <script src="<?php echo base_url(); ?>assets/admin/js/Chart.extension.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin/js/map.js"></script>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDOz5oWyuWCeyh-9c1W5gexDzRakcRP-eM" async defer></script>
    
    
   <!-- <script src="<?php echo base_url(); ?>assets/admin/js/sweetalert.all.js"></script>-->
    ...
    <script src="<?php echo base_url(); ?>assets/admin/js/argon.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin/js/myjavascript.js"></script>
